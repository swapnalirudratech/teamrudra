<?php
$page_title = "Professional CMS Development Services – Rudratech";
...
<body class="bg-white font-sans text-slate-900 overflow-x-hidden">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2">
                    ...
                    <p class="text-slate-500 italic border-l-4 border-blue-600 pl-6 py-2">
                        Update, edit, and manage your website content without coding knowledge. Our solutions save time, reduce costs, and ensure flexibility.
                    </p>
                </div>
                <div class="lg:w-1/2 grid grid-cols-2 gap-4">
                    <div class="p-8 bg-slate-50 rounded-3xl text-center border border-slate-100 hover:bg-white hover:shadow-xl transition-all">
                        <p class="text-sm text-slate-400 font-bold uppercase">Startups</p>
                        <p class="text-3xl font-black text-blue-600 mt-2">+90%</p>
                        <p class="text-xs text-slate-500 mt-1">Control Efficiency</p>
                    </div>
                    <div class="p-8 bg-slate-50 rounded-3xl text-center border border-slate-100 hover:bg-white hover:shadow-xl transition-all">
                        <p class="text-sm text-slate-400 font-bold uppercase">Performance</p>
                        <p class="text-3xl font-black text-blue-600 mt-2">100%</p>
                        <p class="text-xs text-slate-500 mt-1">Mobile Responsive</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="relative py-24 max-md:py-12  bg-white overflow-hidden">
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute -left-20 top-0 w-96 h-96 bg-blue-100/60 rounded-full blur-[100px]"></div>
        ...
        <div class="relative z-10 w-[85%] mx-auto ">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div class="w-full lg:w-1/4 space-y-16 lg:pr-8 lg:border-r border-slate-100 order-2 lg:order-1">
                ...
                <div class="w-full lg:w-2/4 order-1 lg:order-2">
                    <div class="relative rounded-[3.5rem] overflow-hidden shadow-[0_60px_100px_rgba(0,0,0,0.12)] border-[14px] border-white group bg-slate-100">
                        <img src="/asset/software/cmsdev.png" alt="CMS Development" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000">
                    </div>
                </div>

                <div class="w-full lg:w-1/4 space-y-16 lg:pl-8 lg:border-l border-slate-100 order-3">
        ...
        <div class="w-[85%] mx-auto ">
            ...
            <div class="mb-16 text-center lg:text-left flex flex-col lg:flex-row justify-between items-end gap-6">
                ...
                <p class="text-slate-500 font-medium max-w-sm leading-relaxed">
                    Experience the seamless integration between premium user interfaces and intuitive admin dashboards built by **Rudratech**.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="group relative bg-white rounded-[3rem] max-md:rounded-xl max-md:p-2 p-4 shadow-xl border border-slate-100 overflow-hidden">
                    ...
                    <div class="relative h-[450px] max-md:h-[200px] rounded-[2rem] max-md:rounded overflow-hidden cursor-ew-resize">
                        ...
                        <div class="absolute inset-0 w-full group-hover:w-0 transition-all duration-700 ease-in-out border-r-4 border-white shadow-2xl z-10 overflow-hidden">
                            <img src="/asset/software/kesarbag.jpg" alt="Live Website" class="w-full h-full object-cover max-w-none">
                            <div class="absolute bottom-6 left-6 bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl text-xs font-bold text-slate-900 shadow-lg uppercase tracking-widest">
                                Live Website
                            </div>
                        </div>

                        <div class="absolute bottom-6 right-6 bg-blue-600 px-4 py-2 rounded-xl text-xs font-bold text-white shadow-lg uppercase tracking-widest">
                            Admin Dashboard
                        </div>
                    </div>
                ...
                <div class="group relative bg-white rounded-[3rem] max-md:rounded-xl max-md:p-2 p-4 shadow-xl border border-slate-100 overflow-hidden">
                    ...
                    <div class="relative h-[450px] max-md:h-[200px] rounded-[2rem] max-md:rounded overflow-hidden cursor-ew-resize">
                        ...
                        <div class="absolute inset-0 w-full group-hover:w-0 transition-all duration-700 ease-in-out border-r-4 border-white shadow-2xl z-10 overflow-hidden">
                            <img src="/asset/software/pranna.jpg" alt="Shopify Storefront" class="w-full h-full object-cover max-w-none">
                            <div class="absolute bottom-6 left-6 bg-white/90 backdrop-blur-md px-4 py-2 rounded-xl text-xs font-bold text-slate-900 shadow-lg uppercase tracking-widest">
                                Storefront
                            </div>
                        </div>

                        <div class="absolute bottom-6 right-6 bg-emerald-600 px-4 py-2 rounded-xl text-xs font-bold text-white shadow-lg uppercase tracking-widest">
                            Store Management
                        </div>
                    </div>
                    <p class="mt-6 px-4 text-slate-500 text-sm font-medium italic">Hover to explore the internal inventory and order management system.</p>
                </div>
        ...
        <div class="w-[85%] mx-auto ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:gap-4">
                <div class="group bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500">
                    ...
                    <h4 class="text-2xl font-bold text-slate-900 mb-4">Custom CMS Development</h4>
                    <p class="text-slate-500 leading-relaxed text-sm">Unique CMS solutions built to match your specific business requirements and workflow.</p>
                </div>
                <div class="group bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500">
                    <div class="w-16 h-16 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                        <i class="fab fa-wordpress-simple text-2xl"></i>
                    </div>
                    <h4 class="text-2xl font-bold text-slate-900 mb-4">Open-Source Mastery</h4>
                    <p class="text-slate-500 leading-relaxed text-sm">We deliver robust, scalable websites using WordPress, Joomla, and Drupal.</p>
                </div>
                <div class="group bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500">
                    ...
                    <h4 class="text-2xl font-bold text-slate-900 mb-4">Plugin & Modules</h4>
                    <p class="text-slate-500 leading-relaxed text-sm">Extend capabilities with custom modules tailored to your business needs.</p>
                </div>
            </div>
            <div class="mt-16 text-center">
                <a href="#contact" class="inline-block border-b-2 border-blue-600 text-blue-600 font-bold pb-1 hover:text-slate-900 hover:border-slate-900 transition-all">Request a Free Quote <i class="fas fa-arrow-right ml-2"></i></a>
            </div>
        </div>
    </section>
        ...
        <div class="w-[80%] mx-auto ">
            ...
            <div class="mt-8 text-center lg:text-left">
                <p class="text-slate-400 text-[10px] font-bold uppercase tracking-[0.5em]">
                    Rudratech • Strategic CMS Development • Mumbai
                </p>
            </div>
        </div>
    </section>
