    ...
    <section class="py-12 border-b border-gray-200 bg-cover bg-bottom  w-full h-[90vh] max-md:h-[80vh] max-lg:h-[40vh] flex items-center  justify-center relative" style="background-image: url('/asset/citybg.jpg');">
        ...
        <div class=" flex items-center justify-center w-[85%] ">
            ...
            <div class="relative space-y-4 ">
                <h3 class="text-4xl max-md:text-2xl font-extrabold text-white leading-tight text-center">
                    Custom Software Solutions <br>
                    <span id="text-container" class="text-6xl max-md:text-4xl py-4 font-bold text-white inline-block min-w-[280px] drop-shadow-lg">
                        Development
                    </span>
                </h3>
                <p class="text-4xl max-md:text-2xl text-white  text-center font-extrabold">
                    Driving Business Growth in Badlapur
                </p>
            </div>
        </div>
    </section>
