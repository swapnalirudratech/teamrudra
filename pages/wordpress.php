        ...
        <div class="w-[85%] mx-auto grid lg:grid-cols-2 gap-0">
            ...
            <div class=" mt-16 lg:mt-0 relative">
                <div class="  overflow-hidden">
                    <img src="/asset/bnr/5.png" class="w-full h-full object-cover " alt="WordPress Hero">
                </div>
                <div class="absolute -bottom-10 -left-20 bg-white p-8 rounded-3xl shadow-2xl hidden xl:block max-w-[280px] border border-slate-100">

                    <h4 class="font-bold text-lg">Kesarbaug Organic E-Commerce</h4>
                    <div class="w-full bg-slate-100 h-1 mt-4 rounded-full overflow-hidden">
                        <div class="bg-blue-600 h-full w-[98%]"></div>
                    </div>
                    <p class="text-[10px] text-slate-400 mt-2 italic">Performance Optimized: 98%</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="w-[85%] mx-auto">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-10 md:gap-24">
                ...
                <div class="lg:w-1/2 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 pt-4">
