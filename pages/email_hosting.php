...
<body>
    ...
    <section id="services" class="py-20 bg-white relative overflow-hidden border-t border-slate-100">
        ...
        <div class="w-[85%] mx-auto relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                <div data-aos="fade-up" data-aos-delay="100" class="group bg-white p-10 rounded-[2rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:shadow-blue-900/10 transition-all duration-500 transform hover:-translate-y-3">
                    <div class="w-24 h-24 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                        <img src="/asset/mailadd.jpg" class="w-full h-full object-contain rounded-xl" alt="Professional Email">
                    </div>
                    <h4 class="text-2xl font-black text-slate-900 mb-4 tracking-tight">Professional Email Addresses</h4>
                    <p class="text-slate-500 leading-relaxed font-medium text-sm">
                        Create branded email addresses <span class="text-slate-900 font-bold">(you@yourcompany.com)</span> to enhance credibility and trust with your clients.
                    </p>
                    <div class="mt-8 h-1.5 w-12 bg-blue-600 rounded-full group-hover:w-full transition-all duration-500"></div>
                </div>

                <div data-aos="fade-up" data-aos-delay="200" class="group bg-white p-10 rounded-[2rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:shadow-blue-900/10 transition-all duration-500 transform hover:-translate-y-3">
                    <div class="w-24 h-24 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                        <img src="/asset/spam.png" class="w-full h-full object-contain rounded-xl" alt="Spam Protection">
                    </div>
                    <h4 class="text-2xl font-black text-slate-900 mb-4 tracking-tight">Spam & Virus Protection</h4>
                    <p class="text-slate-500 leading-relaxed font-medium text-sm">
                        Built-in protection with <span class="text-blue-600 font-bold">advanced filters</span> and antivirus scanning to keep your inbox clean and secure.
                    </p>
                    <div class="mt-8 h-1.5 w-12 bg-blue-600 rounded-full group-hover:w-full transition-all duration-500"></div>
                </div>

                <div data-aos="fade-up" data-aos-delay="300" class="group bg-white p-10 rounded-[2rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:shadow-blue-900/10 transition-all duration-500 transform hover:-translate-y-3">
                    <div class="w-24 h-24 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-500">
                        <img src="/asset/migration.png" class="w-full h-full object-contain rounded-xl" alt="Migration Support">
                    </div>
                    <h4 class="text-2xl font-black text-slate-900 mb-4 tracking-tight">Email Migration Support</h4>
                    <p class="text-slate-500 leading-relaxed font-medium text-sm">
                        Hassle-free migration of your existing emails and contacts to our platform with <span class="text-slate-900 font-bold">expert guidance</span> every step.
                    </p>
                    <div class="mt-8 h-1.5 w-12 bg-blue-600 rounded-full group-hover:w-full transition-all duration-500"></div>
                </div>
            </div>
        ...
        <div class="w-[85%] mx-auto">
            <div class="grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div class="space-y-8 order-1 lg:order-2" data-aos="fade-left">
                    <div class="space-y-4">
                        <h2 class="text-2xl lg:text-5xl font-bold text-slate-900 leading-[1.1] tracking-tight">
                    ...
                    <div class="pt-4">
                        <a href="/get-custom-emails" class="inline-flex items-center gap-3 px-8 py-4 bg-blue-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 active:scale-95 group">
                            Get custom emails
    ...
    <section class="relative py-12 bg-white overflow-hidden">
        <div class="absolute top-1/2 right-0 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-50/50 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div class="w-[85%] mx-auto relative z-10">
            <div class="grid lg:grid-cols-2 gap-20 items-center">
                <div class="space-y-8 order-2 lg:order-1" data-aos="fade-right">
                    ...
                    <div class="pt-4">
                        <a href="/get-in-touch" class="group inline-flex items-center gap-3 text-blue-600 font-black uppercase text-sm tracking-widest hover:text-slate-900 transition-colors">
                            Get in touch
                            <span class="h-8 w-8 rounded-full border-2 border-blue-600 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all">
    ...
    <section class="relative bg-gray-50 py-24 px-6 overflow-hidden font-sans">
        ...
        <div class="w-[85%] mx-auto flex flex-col md:flex-row items-center justify-between relative z-10">
            ...
            <div class="md:w-1/2 mt-12 md:mt-0 flex flex-col items-center relative">
                <div class="relative mx-auto border-gray-900 bg-gray-900 border-[14px] rounded-[2.5rem] h-[650px] w-[310px] shadow-2xl overflow-hidden">
                    <div class="h-[46px] w-[3px] bg-gray-800 absolute -left-[14px] top-[124px] rounded-l-lg"></div>
                    <div class="h-[64px] w-[3px] bg-gray-800 absolute -right-[14px] top-[142px] rounded-r-lg"></div>

                    <div id="phone-screen" class="bg-[#121212] h-full w-full overflow-hidden transition-colors duration-500 flex flex-col text-white">
                        <div class="flex justify-between items-center px-6 pt-5 pb-2 select-none" id="status-bar">
                            <span class="text-[11px] font-bold">9:41</span>
                        ...
                        <div class="px-4 py-2 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center font-bold text-xs border-2 border-white/10 shadow-lg">RT</div>
                                <div>
                                    <p class="font-bold text-sm" id="phone-brand-name">RudraTech</p>
                                    <p class="text-[10px] opacity-50">admin@rudratech.com</p>
                                </div>
                            </div>
                            <div class="flex gap-4 opacity-70 text-sm">
                                <span><i class="fa-regular fa-bell"></i></span>
                                <span><i class="fa-regular fa-envelope"></i></span>
                            </div>
                        </div>

                        <div id="app-content" class="flex-1 p-4 overflow-y-auto"></div>
                ...
                <div class="mt-10 flex items-center gap-4 cursor-pointer select-none" onclick="togglePhoneMode()">
                    <div id="toggle-bg" class="w-12 h-6 bg-blue-600 rounded-full p-1 flex items-center transition-colors">
                        <div id="toggle-circle" class="w-4 h-4 bg-white rounded-full transition-transform translate-x-6"></div>
                    </div>
                    <span id="mode-text" class="text-sm font-bold text-gray-700">Dark Mode</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', () => {
            switchTab('mail', document.querySelector('.tab-btn'));
        });
        ...
        function togglePhoneMode() {
            ...
            const activeBtn = document.querySelector('.tab-btn.text-orange-500') || document.querySelector('.tab-btn.text-blue-600');
            const tabName = activeBtn.innerText.toLowerCase().trim().split('\n')[1].trim();
        ...
        function switchTab(tab, el) {
            ...
            const activeColor = isDark ? 'text-orange-500' : 'text-blue-600';
            const subTextClass = isDark ? 'text-gray-400' : 'text-gray-500';
            const itemBg = isDark ? 'bg-white/5' : 'bg-gray-100';
            const borderCol = isDark ? 'border-white/5' : 'border-gray-200';

            btns.forEach(btn => {
                btn.classList.remove('text-orange-500', 'text-blue-600');
                btn.classList.add('text-gray-500');
            });
            el.classList.add(activeColor);
            el.classList.remove('text-gray-500');

            if (tab.includes('mail')) {
                container.innerHTML = `
                    <div class="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        <div class="${itemBg} rounded-lg p-2.5 flex items-center gap-2 text-xs opacity-60">
                        ...
                        <div class="space-y-1">
                            <div class="flex items-center justify-between p-3 rounded-lg ${activeColor} bg-opacity-10 font-bold text-sm">
                                <div class="flex items-center gap-3"><span>📂</span> Inbox</div>
                                <span class="text-xs opacity-70">271</span>
                            </div>
                            <div class="pl-10 space-y-3 pt-2 text-xs ${subTextClass}">
                                <div class="flex justify-between items-center"><span>↳ ToMe</span><span class="opacity-60">63</span></div>
                                <div>↳ Marketing</div>
                ...
                container.innerHTML = `
                    <div class="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div class="space-y-3">
                            ${['Ananya Sharma', 'Rajesh Kumar', 'Sara Khan'].map(name => `
                                <div class="flex items-center gap-3 p-2 border-b ${borderCol}">
                                    <div class="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-sky-400 flex items-center justify-center text-[10px] font-bold text-white">
                                        ${name.split(' ').map(n => n[0]).join('')}
                                    </div>
                                    <div class="flex-1">
                                        <p class="text-sm font-semibold">${name}</p>
                                        <p class="text-[10px] opacity-50">${name.toLowerCase().replace(' ', '.')}@rudratech.com</p>
                                    </div>
                                    <span class="text-xs opacity-30"><i class="fa-solid fa-chevron-right"></i></span>
                                </div>
                            `).join('')}
                        </div>
                    </div>`;
                    ...
                    <div class="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div class="space-y-2">
                            <div class="flex items-center justify-between p-4 ${itemBg} rounded-2xl">
                                ...
                                <span class="text-blue-500 font-bold text-xs">ON</span>
                            </div>
                            <div class="flex items-center justify-between p-4 ${itemBg} rounded-2xl">
                                <div class="flex items-center gap-3 text-sm"><span>🔒</span> Privacy & Security</div>
                                <span class="opacity-30">❯</span>
                            </div>
                            <div class="flex items-center justify-between p-4 ${itemBg} rounded-2xl">
                                <div class="flex items-center gap-3 text-sm"><span>📊</span> Data Usage</div>
                                <span class="opacity-30">❯</span>
                            </div>
                            <div class="mt-6 p-4 border border-red-500/20 rounded-2xl text-center">
                                <button class="text-red-500 text-sm font-bold">Sign Out</button>
                            </div>
                        </div>
                    </div>`;
            }
