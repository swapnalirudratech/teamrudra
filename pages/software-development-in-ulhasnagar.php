...
<body>
    ...
    <section class="py-12 border-b border-gray-200 bg-cover bg-bottom  w-full h-[90vh] max-md:h-[80vh] max-lg:h-[40vh] flex items-center  justify-center relative" style="background-image: url('/asset/citybg.jpg');">
        ...
        <div class=" flex items-center justify-center w-[85%] ">
            ...
            <div class="relative">
                <h3 class="text-4xl max-md:text-2xl font-bold text-slate-100 leading-tight text-center">
                    Custom Software Development Solutions in <br>
                    <span class="text-6xl max-md:text-4xl max-lg:text-5xl py-4 font-extrabold text-white inline-block min-w-[280px] drop-shadow-lg">
                        Ulhasnagar
                    </span>
                </h3>
