...
<body>
    ...
    <section class="py-12 border-b border-gray-200 bg-cover bg-bottom  w-full h-[90vh] max-md:h-[80vh] max-lg:h-[40vh] flex items-center  justify-center relative" style="background-image: url('/asset/citybg.jpg');">
        ...
        <div class="absolute inset-0 bg-gradient-to-tr from-transparent via-black/50 to-transparent opacity-100"></div>

        <div class=" flex items-center justify-center w-[85%] ">

            <div class="relative space-y-12">
                <h2 class="text-4xl max-md:text-2xl font-extrabold text-slate-100 leading-tight text-center">
                    Expert Website Development in Shahad<br>
                    <span class="relative inline-block min-w-full min-h-16 mt-4">
                        <span id="text-container" class="text-5xl max-md:text-3xl font-extrabold text-gradient inline-block min-w-[280px] drop-shadow-lg">
                            Innovative Websites for Your Business
                        </span>
                    </span>
                </h2>
            </div>
